...
const Hero = () => {
    ...
    return (
        <div className="hero_style__start" id="hero">
            <div className="lg:grid grid-cols-12 xl:gap-base gap-3 mx-auto xl:px-base px-3 overflow-hidden">
                <div className="lg:col-span-3 md:col-span-6 hidden lg:flex flex-col">
                    <div className="group hero-card-sm">
                        <a href="package-list-sidebar.html">
                            <img
                                src="https://images.pexels.com/photos/18274181/pexels-photo-18274181/free-photo-of-crowd-around-kaaba-in-mecca-at-sunset.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt="placeholder"
                            ...
                            <div className="text-white absolute w-full lg:bottom-10 bottom-6 text-center">
                                ...
                                <p className="font-medium lg:text-md text-base mt-1 mb-3">
                                    {t("banner_image_sub_h_1")}
                                </p>
                    ...
                    <div className="group hero-card-sm">
                        <a href="package-list-sidebar.html">
                            <img
                                src="https://images.pexels.com/photos/12167059/pexels-photo-12167059.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt="placeholder"
                                className="lg:h-full w-full object-cover group-hover:scale-110 duration-500"
                            />
                            <div className="text-white absolute w-full lg:bottom-10 bottom-6 text-center">
                                ...
                                <p className="font-medium lg:text-md text-base mt-1 mb-3">{t("banner_image_sub_h_2")}</p>
                                <div className="h-[3px] w-9 bg-white rounded-md mx-auto"></div>
                            </div>
                        </a>
                    </div>
                ...
                <div
                    className="lg:col-span-6 md:col-span-12 xl:min-h-screen lg:py-30 py-20 bg-[url('../images/hero/hero.webp')] bg-cover bg-center bg-no-repeat flex justify-center items-center"
                >
                            ...
                            <div className="relative lg:mt-12 mt-base">
                                ...
                                <div className="absolute top-1/2 -translate-y-1/2 left-5 lg:left-base max-w-[20px]">
                                    <svg
                                        ...
                                        <path d="M17.1834 7.25002C16.3167 3.39169 12.95 1.66669 10 1.66669C10 1.66669 10 1.66669 9.9917 1.66669C7.05004 1.66669 3.6917 3.39169 2.8167 7.24169C1.83337 11.5417 4.4667 15.1834 6.85004 17.4834C7.73337 18.3334 8.8667 18.7584 10 18.7584C11.1334 18.7584 12.2667 18.3334 13.1417 17.4834C15.525 15.1834 18.1584 11.55 17.1834 7.25002Z"
                                            fill="currentColor" />
                            ...
                            <div className="relative lg:mt-10 mt-6 select_style__one">
                                ...
                                >
                                    ...
                                    {tourOptions.map(tOption => (
                                        <option value={tOption.value}>{tOption.label}</option>
                                    ))}
                                </select>

                                <div
                                    className="absolute top-1/2 -translate-y-1/2 left-5 lg:left-base max-w-[20px]"
                                >
                                    <svg
                                        width="20"
                                        height="20"
                ...
                <div className="lg:col-span-3 md:col-span-6 hidden lg:flex flex-col">
                    <div className="group hero-card-sm">
                        <a href="package-list-sidebar.html">
                            ...
                            />
                            <div
                                className="text-white absolute w-full lg:bottom-10 bottom-6 text-center"
                            >
                                <h3
                                    className="font-extrabold 2xl:text-xl md:text-lg text-2md leading-1.6 group-hover:text-primary-1 duration-300 group-hover:tracking-wide"
                                >
                                    {t("banner_image_h_3")}
                                </h3>
                                <p className="font-medium lg:text-md text-base mt-1 mb-3">
                                    {t("banner_image_sub_h_3")}
                    ...
                    <div className="group hero-card-sm">
                        <a href="package-list-sidebar.html">
                            <img
                                src="https://images.pexels.com/photos/14389954/pexels-photo-14389954.jpeg"
                                alt="placeholder"
                                className="lg:h-full w-full object-cover group-hover:scale-110 duration-500"
                            />
                            <div
